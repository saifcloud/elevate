           ...
           <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="post" novalidate action="{{ url('admin/subcategory-store')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="en_subcategory" required>
                                    <p class="text-danger">{{ $errors->first('en_subcategory') }}</p>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label>Arabic subcategory</label>
                                    <input type="email" class="form-control" name="ar_subcategory" required>
