           ...
           <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" method="post" novalidate action="{{ url('admin/color-update')}}" enctype="multipart/form-data">
                                @csrf
                               ...
                               <input type="hidden" name="color_id" value="{{ base64_encode($color->id)}}">
                                 ...
                                 <div class="form-group col-sm-6">
                                    ...
                                    <select name="category" class="form-control" id="category">
                                        ...
                                        <option value="{{ $row->id }}" {{ $row->id == $color->category_id ? "selected":""}}>{{ $row->en_category }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                 ...
                                 <div class="form-group col-sm-6">
                                    ...
                                    <select name="sub_subcategory" class="form-control" id="subsubcategory">
                                        ...
                                        <option value="{{ $row->id }}" {{ $row->id == $color->subsubcategory_id ? "selected":""}}>{{ $row->en_subsubcategory }}</option>
                                        @endforeach
                                        @endif
                                 ...
                                 <div class="form-group col-sm-6">
                                    ...
                                    <select name="type" class="form-control" id="type">
                                        ...
                                        @foreach($type as $row )
                                        <option value="{{ $row->id }}" {{ $row->id == $color->type_id ? "selected":""}}>{{ $row->en_type }}</option>
                                        @endforeach
                                        @endif
