                                    ...
                                    <table id="type-table" class="table table-striped">
                                        ...
                                        <tbody>
                                          ...
                                          <!--   <td><img src="{{ url('/').$row->image}}" width="200px" height="100px"></td> -->
                                            ...
                                            <td>
                                                <a href="{{ url('admin/size-edit/'.base64_encode($row->id))}}" class="btn btn-warning">Edit</a>
                                                <a href="{{ url('admin/size-delete/'.base64_encode($row->id))}}" class="btn btn-danger">Delete</a>
                                            </td>
                                            </tr>
                                            @endforeach
                                            @endif
