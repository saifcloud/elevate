        ...
        <div class="block-header">
            <div class="row clearfix">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    ...
                    <a href="{{ url('admin/type-create')}}" class="btn btn-sm btn-primary" title="">Create New</a>
                </div>
            </div>
        </div>
                                ...
                                <div class="body">
                                    <table id="type-table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <a href="{{ url('admin/type-edit/'.base64_encode($row->id))}}" class="btn btn-warning">Edit</a>
                                                <a href="{{ url('admin/type-delete/'.base64_encode($row->id))}}" class="btn btn-danger">Delete</a>
                                            </td>
                                            </tr>
                                            @endforeach
                                            @endif
